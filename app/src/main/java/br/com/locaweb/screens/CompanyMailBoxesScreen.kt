...
import br.com.locaweb.components.FilterButton
...
@Composable
fun CompanyMailBoxesScreen(navController: NavHostController) {
    ...
    LaunchedEffect(Unit) {
        val call = RetrofitClient.getServiceWithToken(context).getEmails()
            ...
            LazyColumn {
                items(emailsState) { email ->
                    MailBox(
                        ...
                        onRowClick = { navController.navigate("EmailScreen/${email.id}") },
